export default {
  ...
  GRAPH_DELTA_ENDPOINT:`${"https://graph.microsoft.com/"}${"v1.0/root?delta/$select=sharepointIds, title, name, webUrl, fields,parentReferenceIds"}`,
  GRAPH_DRIVEITEM_ENDPOINT:"https://graph.microsoft.com/v1.0/sites/ed68a410-1774-4cbd-91b8-e22403d0e3c6/lists/b6172375-d599-467b-8327-301b20dc3a06/items?$expand=fields, driveitem&$select=fields, id, contentType, id",
  // SCOPES
